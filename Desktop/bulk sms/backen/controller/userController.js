...
// No need to call 'upload' here again as it's already being used as middleware
const updateUserProfile = async (req, res) => {
  ...
  try {
    ...
    // If there's a file, add its path to the body so it can be updated
    if (req.file) {
    ...
    // Maybe remove sensitive data before sending user back
    const { password, resetPasswordToken, resetPasswordExpire, ...result } = user.toObject();
